export const blogs = [
  ...
  {
    id: 2,
    slug: 'fern-propagation-techniques',
  ...
  {
    id: 3,
    slug: 'substrate-layering-fundamentals',
  ...
  {
    id: 4,
    slug: 'aquascaping-hardscape-design',
    title: "Hardscape Design Principles",
    description: "Learn the fundamentals of creating stunning aquascapes using rocks, wood, and composition rules.",
  ...
  {
    id: 5,
    slug: 'tropical-plant-care',
    title: "Tropical Plant Care Mastery",
    description: "Complete guide to caring for tropical plants in high-humidity environments and terrariums.",
  ...
  },
  {
    ...
    description: "Deep dive into the aquarium nitrogen cycle and how to establish a healthy biological filter.",
    category: "Aquatic Plants",
    difficulty: "Advanced",
  ...
  {
    id: 7,
    slug: 'terrarium-building-guide',
    title: "Complete Terrarium Building Guide",
    description: "Step-by-step guide to constructing your own closed or open terrarium ecosystem.",
    category: "Terrarium",
    difficulty: "Easy",
  ...
  {
    id: 8,
    slug: 'low-light-aquatic-plants',
    title: "Low-Light Aquatic Plants Guide",
    description: "Best aquatic plants for low-light environments and how to care for them.",
    category: "Aquatic Plants",
    difficulty: "Easy",
