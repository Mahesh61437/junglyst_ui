    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', fontFamily: 'var(--font-sans)' }}>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '1.5rem' }}>
        <p style={{ color: '#64748b', fontSize: '0.85rem', marginBottom: '1.25rem', lineHeight: 1.6 }}>
          Generic key/value store for platform-wide settings. Each entry has a unique <strong>key</strong> (string) and a <strong>value</strong> (any JSON). Used for things like the competition result-announcement date, active payment gateway, shipping platform, feature flags, etc.
        </p>
